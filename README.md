...
├── assets/
│   └── diagrama-classes.png ← diagrama UML fornecido na atividade
├── docs/
│   └── atividade.md         ← enunciado, requisitos e critérios de avaliação
...
| Documento                                | Descrição                                                      |
| ---------------------------------------- | -------------------------------------------------------------- |
| [Enunciado da Atividade](docs/README.md) | Objetivo, requisitos de implementação e diagrama UML fornecido |
